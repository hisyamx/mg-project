...
var DatatableBasic = function () {
    ...
    Fullcalendar = function () {
        ...
        t.length && (a = {
            ...
            "update" === a && ("" != n ? (s[0].title = n, s[0].description = i, s[0].className = [o], console.log(o), e.fullCalendar("updateEvent", s[0]), $("#edit-event").modal("hide")) : ($(".edit-event--title").closest(".form-group").addClass("has-error"), $(".edit-event--title").focus())), "delete" === a && ($("#edit-event").modal("hide"), setTimeout(function () {
                swal({
                    title: "Are you sure?",
