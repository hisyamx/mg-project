            ...
            <div class="card card-profile">
                ...
                <div class="card-body pt-7">
                    <div class="text-center">
                        ...
                        <div class="h5 font-weight-300">
                            <i class="ni location_pin mr-2"></i>{{ Auth::user()->getRole() }}
                        </div>
                        <div class="h5 font-weight-300">
                            <i class="ni location_pin mr-2"></i>{{ Auth::user()->division }}
                        </div>
                        <div>
                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        {{-- <div class="col-lg-6 text-right">
                            <a href="{{ route('admin.magang.create') }}" class="btn btn-sm btn-neutral">Edit
                        Profile</a>
                    </div> --}}
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="input-address" class="form-control" value="{{ Auth::user()->telephone }}"
                                        type="text">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="input-address" class="form-control" value="{{ Auth::user()->address }}"
                                        type="text">
                                </div>
                            </div>
                        </div>
